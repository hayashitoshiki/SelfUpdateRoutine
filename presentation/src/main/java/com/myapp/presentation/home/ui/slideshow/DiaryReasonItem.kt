...
class DiaryReasonItem(
    ...
    override fun bind(
        ...
        binding.txtSection.text = context.getString(R.string.section2_2)
        binding.txtTitle.text = context.getString(R.string.title_item_reason) // 次へボタン
