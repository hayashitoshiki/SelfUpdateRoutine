...
class DiaryStatementItem(
    ...
    override fun bind(
        ...
        binding.txtSection.text = context.getString(R.string.section1_4)
        binding.txtTitle.text = context.getString(R.string.title_item_declaration) // 次へボタン
