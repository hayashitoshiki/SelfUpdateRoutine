[document](../../index.md) / [com.myapp.presentation.ui.mission_statement](../index.md) / [MissionStatementSettingFragment](./index.md)

# MissionStatementSettingFragment

`class MissionStatementSettingFragment : `[`BaseFragment`](../../com.myapp.presentation.utils/-base-fragment/index.md)
...
| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `MissionStatementSettingFragment()`<br>ミッションステートメント設定画面 |
